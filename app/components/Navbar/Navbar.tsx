...
const Navbar: React.FC = () => {
    ...
    useEffect(() => {
        ...
        document.documentElement.classList.toggle('dark', prefersDark || storedTheme === 'dark');
    }, []);
                ...
                <div className="mx-auto max-w-7xl p-3 md:p-4 lg:px-8">
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            {/* DARK MODE TOGGLE */}
                            <div className="ml-4">
                                <button onClick={toggleDarkMode} aria-label="Toggle Dark Mode" className="text-white">
                                    {isDarkMode ? (
